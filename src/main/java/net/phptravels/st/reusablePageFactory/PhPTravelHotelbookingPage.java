...
public class PhPTravelHotelbookingPage {
	...
	/*public static String hotelRatingXpathPrefix = "//div[@class='rating']//input[@id='";
	public static String hotelRatingXpathSuffix = "']";*/
	
	
	/**
	 * @author SoumyaRoy
	 * Booking a Hotel on the basis of Filter Section
	 */
	public void bookHotelByFilterSection(String star) {
		...
		try {
			 ...
			 */
			switch(star){
				case "1": oneStarHotelRatingRadioBtnFilter.click();
					break;
				case "2": twoStarHotelRatingRadioBtnFilter.click();
					break;
				case "3": threeStarHotelRatingRadioBtnFilter.click();
					break;
				case "4": fourStarHotelRatingRadioBtnFilter.click();
					break;
				case "5": fiveStarHotelRatingRadioBtnFilter.click();
					break;
			}
			...
			userNameTextBoxRoomBooking.sendKeys(Constants.UserName);; //typing userName
