...
public class CasualDressBookingPage {
	...
	public void buyCasualDresses() {
		try {
			/*
			 * Actions builder = new Actions(driver); Action mouseOverDresses =
			 * builder.moveToElement(dressesLink).build(); mouseOverDresses.perform();
			 */
			...
			Assert.assertEquals(confirmationMessagePath.getText(), Constants.Expected_Order_Confirmation_Message,
